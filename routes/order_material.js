...
const orderMaterialController = require('../http/controllers/orderMaterial');
...
router.get('/:id',permissionMiddleware("orderMaterial:one"), validationMiddleware(orderMaterialValidator.id, 'params'), orderMaterialController.getOne);
